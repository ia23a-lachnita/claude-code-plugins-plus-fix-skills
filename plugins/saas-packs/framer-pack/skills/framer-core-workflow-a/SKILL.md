...
## Overview
Primary money-path workflow for Framer. This is the most common use case.

## Prerequisites
- Completed `framer-install-auth` setup
- Understanding of Framer core concepts
...
- Expected results from Framer API
...
## Next Steps
For secondary workflow, see `framer-core-workflow-b`.