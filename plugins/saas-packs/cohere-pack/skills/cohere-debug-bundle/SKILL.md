...
description: |
  ...
  or collecting diagnostic information for Cohere problems.
...
## Output
- `cohere-debug-YYYYMMDD-HHMMSS.tar.gz` archive containing:
...
### Submit to Support
1. Create bundle: `bash cohere-debug-bundle.sh`
2. Review for sensitive data
3. Upload to Cohere support portal
