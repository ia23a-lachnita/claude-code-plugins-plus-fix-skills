...
description: |
  ...
  or optimizing API request throughput for Apple Notes.
  Trigger with phrases like "apple-notes rate limit", "apple-notes throttling",
  "apple-notes 429", "apple-notes retry", "apple-notes backoff".
...
## Resources
- [Apple Notes Rate Limits](https://docs.apple-notes.com/rate-limits)
- [p-queue Documentation](https://github.com/sindresorhus/p-queue)

## Next Steps
For security configuration, see `apple-notes-security-basics`.