...
description: |
  Configure Snowflake local development with hot reload and testing.
  Use when setting up a development environment, configuring test workflows,
  or establishing a fast iteration cycle with Snowflake.
  Trigger with phrases like "snowflake dev setup", "snowflake local development",
  "snowflake dev environment", "develop with snowflake".
