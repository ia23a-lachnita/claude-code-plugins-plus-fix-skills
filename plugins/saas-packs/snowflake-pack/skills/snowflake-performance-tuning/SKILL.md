...
description: |
  ...
  or optimizing request throughput for Snowflake integrations.
  Trigger with phrases like "snowflake performance", "optimize snowflake",
  "snowflake latency", "snowflake caching", "snowflake slow", "snowflake batch".
...
## Resources
- [Snowflake Performance Guide](https://docs.snowflake.com/performance)
