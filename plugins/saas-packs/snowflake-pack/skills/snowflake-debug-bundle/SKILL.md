...
description: |
  ...
  or collecting diagnostic information for Snowflake problems.
  Trigger with phrases like "snowflake debug", "snowflake support bundle",
  "collect snowflake logs", "snowflake diagnostic".
...
## Output
- `snowflake-debug-YYYYMMDD-HHMMSS.tar.gz` archive containing:
...
### Submit to Support
1. Create bundle: `bash snowflake-debug-bundle.sh`
2. Review for sensitive data
3. Upload to Snowflake support portal
...
## Next Steps
For rate limit issues, see `snowflake-rate-limits`.