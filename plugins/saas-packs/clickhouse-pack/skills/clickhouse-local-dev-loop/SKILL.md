...
description: |
  Configure ClickHouse local development with hot reload and testing.
  Use when setting up a development environment, configuring test workflows,
  or establishing a fast iteration cycle with ClickHouse.
  Trigger with phrases like "clickhouse dev setup", "clickhouse local development",
  "clickhouse dev environment", "develop with clickhouse".
