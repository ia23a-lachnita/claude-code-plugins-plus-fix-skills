...
description: |
  Apply OneNote security best practices for secrets and access control.
  Use when securing API keys, implementing least privilege access,
  or auditing OneNote security configuration.
  Trigger with phrases like "onenote security", "onenote secrets",
  "secure onenote", "onenote API key security".
...
## Resources
- [OneNote Security Guide](https://docs.onenote.com/security)
- [OneNote API Scopes](https://docs.onenote.com/scopes)
