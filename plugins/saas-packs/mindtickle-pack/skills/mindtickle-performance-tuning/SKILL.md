...
description: |
  ...
  or optimizing request throughput for Mindtickle integrations.
  Trigger with phrases like "mindtickle performance", "optimize mindtickle",
  "mindtickle latency", "mindtickle caching", "mindtickle slow", "mindtickle batch".
...
## Resources
- [Mindtickle Performance Guide](https://docs.mindtickle.com/performance)
