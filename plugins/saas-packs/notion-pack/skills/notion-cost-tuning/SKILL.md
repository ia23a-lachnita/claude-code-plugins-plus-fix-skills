...
description: |
  Optimize Notion costs through tier selection, sampling, and usage monitoring.
  Use when analyzing Notion billing, reducing API costs,
  or implementing usage monitoring and budget alerts.
  Trigger with phrases like "notion cost", "notion billing",
  "reduce notion costs", "notion pricing", "notion expensive", "notion budget".
...
## Resources
- [Notion Pricing](https://notion.com/pricing)
- [Notion Billing Dashboard](https://dashboard.notion.com/billing)
