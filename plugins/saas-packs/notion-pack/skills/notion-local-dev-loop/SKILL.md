...
description: |
  Configure Notion local development with hot reload and testing.
  Use when setting up a development environment, configuring test workflows,
  or establishing a fast iteration cycle with Notion.
  Trigger with phrases like "notion dev setup", "notion local development",
  "notion dev environment", "develop with notion".
