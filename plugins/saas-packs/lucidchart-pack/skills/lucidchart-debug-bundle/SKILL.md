...
description: |
  ...
  or collecting diagnostic information for Lucidchart problems.
  Trigger with phrases like "lucidchart debug", "lucidchart support bundle",
  "collect lucidchart logs", "lucidchart diagnostic".
...
## Output
- `lucidchart-debug-YYYYMMDD-HHMMSS.tar.gz` archive containing:
...
### Submit to Support
1. Create bundle: `bash lucidchart-debug-bundle.sh`
2. Review for sensitive data
3. Upload to Lucidchart support portal
...
## Next Steps
For rate limit issues, see `lucidchart-rate-limits`.