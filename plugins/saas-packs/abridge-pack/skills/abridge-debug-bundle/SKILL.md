...
description: |
  ...
  or collecting diagnostic information for Abridge problems.
  Trigger with phrases like "abridge debug", "abridge support bundle",
  "collect abridge logs", "abridge diagnostic".
...
## Output
- `abridge-debug-YYYYMMDD-HHMMSS.tar.gz` archive containing:
...
### Submit to Support
1. Create bundle: `bash abridge-debug-bundle.sh`
2. Review for sensitive data
3. Upload to Abridge support portal
...
## Next Steps
For rate limit issues, see `abridge-rate-limits`.