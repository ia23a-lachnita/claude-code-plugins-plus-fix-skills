...
description: |
  ...
  or integrating Abridge tests into your build process.
  Trigger with phrases like "abridge CI", "abridge GitHub Actions",
  "abridge automated tests", "CI abridge".
...
- [Abridge CI Guide](https://docs.abridge.com/ci)

## Next Steps
For deployment patterns, see `abridge-deploy-integration`.