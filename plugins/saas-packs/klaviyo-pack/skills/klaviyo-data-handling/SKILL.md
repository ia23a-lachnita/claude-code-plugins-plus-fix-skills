...
description: |
  Implement Klaviyo PII handling, data retention, and GDPR/CCPA compliance patterns.
  Use when handling sensitive data, implementing data redaction, configuring retention policies,
  or ensuring compliance with privacy regulations for Klaviyo integrations.
...
- [Klaviyo Privacy Guide](https://docs.klaviyo.com/privacy)
