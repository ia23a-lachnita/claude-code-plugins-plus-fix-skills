...
description: |
  Implement Klaviyo rate limiting, backoff, and idempotency patterns.
  ...
  "klaviyo 429", "klaviyo retry", "klaviyo backoff".
...
## Overview
Handle Klaviyo rate limits gracefully with exponential backoff and idempotency.
...
## Resources
- [Klaviyo Rate Limits](https://docs.klaviyo.com/rate-limits)
