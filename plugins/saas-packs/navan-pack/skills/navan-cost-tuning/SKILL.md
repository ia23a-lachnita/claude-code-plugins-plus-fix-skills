...
description: |
  ...
  Use when analyzing Navan billing, reducing API costs,
  or implementing usage monitoring and budget alerts.
  Trigger with phrases like "navan cost", "navan billing",
  "reduce navan costs", "navan pricing", "navan expensive", "navan budget".
...
```bash
# Set up billing alerts in Navan dashboard
# Or use API if available:
# Check Navan documentation for billing APIs
```
...
Review Navan dashboard for usage patterns and costs.
...
const estimate = estimateNavanCost(yourMonthlyRequests);
...
- [Navan Billing Dashboard](https://dashboard.navan.com/billing)

## Next Steps
For architecture patterns, see `navan-reference-architecture`.