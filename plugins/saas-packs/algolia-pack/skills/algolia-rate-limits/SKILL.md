...
description: |
  ...
  or optimizing API request throughput for Algolia.
  Trigger with phrases like "algolia rate limit", "algolia throttling",
  "algolia 429", "algolia retry", "algolia backoff".
...
## Resources
- [Algolia Rate Limits](https://docs.algolia.com/rate-limits)
