...
description: |
  ...
  Use when implementing Palantir integrations, refactoring SDK usage,
  or establishing team coding standards for Palantir.
  Trigger with phrases like "palantir SDK patterns", "palantir best practices",
  "palantir code patterns", "idiomatic palantir".
...
## Resources
- [Palantir SDK Reference](https://docs.palantir.com/sdk)
- [Palantir API Types](https://docs.palantir.com/types)
