...
description: |
  ...
  or establishing a fast iteration cycle with Palantir.
  Trigger with phrases like "palantir dev setup", "palantir local development",
  "palantir dev environment", "develop with palantir".
...
## Next Steps
See `palantir-sdk-patterns` for production-ready code patterns.