...
## Overview
Handle Hex rate limits gracefully with exponential backoff and idempotency.
...
## Resources
- [Hex Rate Limits](https://docs.hex.com/rate-limits)
- [p-queue Documentation](https://github.com/sindresorhus/p-queue)

## Next Steps
For security configuration, see `hex-security-basics`.