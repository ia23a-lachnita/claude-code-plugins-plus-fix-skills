...
## Overview
Primary money-path workflow for Hex. This is the most common use case.

## Prerequisites
- Completed `hex-install-auth` setup
- Understanding of Hex core concepts
...
## Next Steps
For secondary workflow, see `hex-core-workflow-b`.