...
description: |
  Implement Oracle Cloud webhook signature validation and event handling.
  Use when setting up webhook endpoints, implementing signature verification,
  or handling Oracle Cloud event notifications securely.
  Trigger with phrases like "oraclecloud webhook", "oraclecloud events",
  "oraclecloud webhook signature", "handle oraclecloud events", "oraclecloud notifications".
...
## Resources
- [Oracle Cloud Webhooks Guide](https://docs.oraclecloud.com/webhooks)
- [Webhook Security Best Practices](https://docs.oraclecloud.com/webhooks/security)
