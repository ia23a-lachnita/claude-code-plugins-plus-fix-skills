...
description: |
  ...
  Use when encountering AssemblyAI errors, debugging failed requests,
  or troubleshooting integration issues.
  Trigger with phrases like "assemblyai error", "fix assemblyai",
  "assemblyai not working", "debug assemblyai".
...
- [AssemblyAI Error Codes](https://docs.assemblyai.com/errors)
