...
description: |
  ...
  Trigger with phrases like "salesforce SDK patterns", "salesforce best practices",
  "salesforce code patterns", "idiomatic salesforce".
...
## Resources
- [Salesforce SDK Reference](https://docs.salesforce.com/sdk)
- [Salesforce API Types](https://docs.salesforce.com/types)
