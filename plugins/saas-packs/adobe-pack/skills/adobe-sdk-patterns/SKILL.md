...
description: |
  Apply production-ready Adobe SDK patterns for TypeScript and Python.
  Use when implementing Adobe integrations, refactoring SDK usage,
  or establishing team coding standards for Adobe.
  Trigger with phrases like "adobe SDK patterns", "adobe best practices",
  "adobe code patterns", "idiomatic adobe".
...
- [Adobe API Types](https://docs.adobe.com/types)
