...
description: |
  Implement BambooHR rate limiting, backoff, and idempotency patterns.
  ...
  "bamboohr 429", "bamboohr retry", "bamboohr backoff".
...
## Overview
Handle BambooHR rate limits gracefully with exponential backoff and idempotency.
...
## Resources
- [BambooHR Rate Limits](https://docs.bamboohr.com/rate-limits)
