...
description: |
  Execute ClickUp primary workflow: Core Workflow A.
  Use when implementing primary use case,
  building main features, or core integration tasks.
  Trigger with phrases like "clickup main workflow",
  "primary task with clickup".
...
## Overview
Primary money-path workflow for ClickUp. This is the most common use case.
...
## Next Steps
For secondary workflow, see `clickup-core-workflow-b`.