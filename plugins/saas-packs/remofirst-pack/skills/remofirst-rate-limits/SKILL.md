...
description: |
  ...
  or optimizing API request throughput for RemoFirst.
  Trigger with phrases like "remofirst rate limit", "remofirst throttling",
  "remofirst 429", "remofirst retry", "remofirst backoff".
...
## Resources
- [RemoFirst Rate Limits](https://docs.remofirst.com/rate-limits)
- [p-queue Documentation](https://github.com/sindresorhus/p-queue)

## Next Steps
For security configuration, see `remofirst-security-basics`.