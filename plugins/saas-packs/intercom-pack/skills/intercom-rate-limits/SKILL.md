...
description: |
  Implement Intercom rate limiting, backoff, and idempotency patterns.
  ...
  "intercom 429", "intercom retry", "intercom backoff".
...
## Resources
- [Intercom Rate Limits](https://docs.intercom.com/rate-limits)
