...
description: |
  ...
  or collecting diagnostic information for Intercom problems.
  Trigger with phrases like "intercom debug", "intercom support bundle",
  "collect intercom logs", "intercom diagnostic".
...
## Output
- `intercom-debug-YYYYMMDD-HHMMSS.tar.gz` archive containing:
...
### Submit to Support
1. Create bundle: `bash intercom-debug-bundle.sh`
2. Review for sensitive data
3. Upload to Intercom support portal
...
## Next Steps
For rate limit issues, see `intercom-rate-limits`.